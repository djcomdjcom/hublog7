...
?>
<article id="post-<?php the_ID(); ?>"  class="post clearfix post catchup"> <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" class="medium">
  ...
  <div class="metabox">
    ...
    <section class="spec_excerpt"> <span class="kakaku"> <span class="bukken-status">
      <?php // 販売ステータス
      ...
      ?>
      </span> <span class="number"><?php echo $kakaku; ?></span></span>
      <?php if ( post_custom('kakaku-tsubo') ): ?>
      <span class="tsubo"> 坪単価：<?php echo post_custom_cft('kakaku-tsubo'); ?> </span>
      <?php elseif ( post_custom('kakaku-m2') ): ?>
      <span class="tsubo"> 平米単価：<?php echo post_custom_cft('kakaku-m2'); ?> </span>
      <?php endif; ?>
      <span class="address"><?php echo $address; ?></span>
      <?php if ( post_custom('madori') ) : ?>
      <span class="hirosa"> <span class="madori"><?php echo post_custom_cft('madori') ; ?></span>
    ...
    <?php endif; ?>
    <h2 class="title"> <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php printf(__('Permanent Link to %s'), the_title_attribute('echo=0')); ?>">
      <?php
