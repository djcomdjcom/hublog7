...
<article class="post-<?php the_ID(); ?> post clearfix category-sell poststyle-bukken">
  ...
  <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" class="medium">
<?php if ( function_exists('the_post_image') && !the_post_image([300, 300]) ) : ?>
...
<?php endif; ?>
  ...
  <?php endif; ?>
  <?php endif; ?>
  <span class="to_detail"> <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php printf(__('Permanent Link to %s'), the_title_attribute('echo=0')); ?>">詳細情報</a> </span>
