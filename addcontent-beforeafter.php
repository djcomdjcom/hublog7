      ...
      <?php if (!empty($fields['ba_before']) || !empty($fields['add_contents'])): ?>
        ...
        <div class="row maxw-1000 mx-auto p-0 ba-item py-3 mb-5">
          ...
          <div class="col-4 px-0 before-image">
            <figure class="w100">
              <span class="ttl pt-1 pt-md-2 pb-md-1">施工前</span>
              <a href="<?php echo wp_get_attachment_url($ba_before, 'large'); ?>">
                <img src="<?php echo wp_get_attachment_url($ba_before, 'thumbnail'); ?>">
              </a>
            </figure>
          </div>
          <div class="col-1 px-0 arrow text-center align-self-center">
            <span class="material-icons">arrow_forward_ios</span>
          </div>
          <div class="col-7 px-0 after-image">
            <figure class="w100">
              <span class="ttl pt-1 pt-md-2 pb-md-1">施工後</span>
              <a href="<?php echo wp_get_attachment_url($ba_after, 'large'); ?>">
                <img src="<?php echo wp_get_attachment_url($ba_after, 'large'); ?>">
              </a>
            </figure>
          </div>
        </div>
